            ...
            <div className=''>
               ...
               <Menumante/>
                ...
                <div className='mantenedor'>
                    <Button variant="primary" onClick={nuevoRegistro}>Nuevo Registro Lectura</Button>
                    <div className='table'>
                    ...
                    <Modal size={'lg'} show={show} onHide={handleClose} animation={false}>
                        ...
                        <Modal.Body>
                            <div className='formulario'>
                                ...
                                <div >
                                    <div className='cssabel'>Articulo</div>
