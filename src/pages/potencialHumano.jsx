        ...
        <div className='NoirProRegular'>
            ...
            <div className="fila_3_PotencialH NoirProRegular">
                ...
                <div className='cuadros_fila3_PotencialH'>
                    ...
                    <div className='cuadros_fila3_PotencialH_1'>Metodología andragógica</div>
                    <div className='cuadros_fila3_PotencialH_2'>Gamificación</div>
                    <div className='cuadros_fila3_PotencialH_3'>Herramientas de Design Thinking</div>
